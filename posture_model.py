...
# ==============================
def convert_posture_label(posture):
    ...
    return label_map.get(posture, posture)
...
def predict_posture_from_file(csi_file_path):
    ...
    predicted_label = pred_counts.idxmax()
    final_posture = convert_posture_label(predicted_label)
